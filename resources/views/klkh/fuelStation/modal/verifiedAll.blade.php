<div class="modal fade" id="verifiedAll{{ $fuelStation->UUID }}" tabindex="-1" aria-labelledby="modalSupportLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('klkh.fuelStation.verifiedAll', $fuelStation->UUID) }}" method="POST">
                @csrf
