        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    <h4 class="mb-0 fw-semibold">KLKH Fuel Station</h4>
                </div>
            </div>
        </div>
        <div class="card">
            <div class="card-body">
                <form action="{{ route('klkh.fuelStation.post') }}" method="POST" id="submitFormKLKHFuelStation">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-start">
                            <label for="parkir_lv_true" class="me-3 px-2 py-2">
                                <input type="radio" id="parkir_lv_true" name="parkir_lv_check" value="true" required />
                                Ya
                            </label>
                            <label for="parkir_lv_false" class="me-3 px-2 py-2">
                                <input type="radio" id="parkir_lv_false" name="parkir_lv_check" value="false" /> Tidak
                            </label>
                            <label for="parkir_lv_na" class="me-3 px-2 py-2">
                                <input type="radio" id="parkir_lv_na" name="parkir_lv_check" value="n/a" /> N/A
                            </label>
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-start">
                            ...
                            <label for="lampu_kerja_false" class="me-3 px-2 py-2">
                                <input type="radio" id="lampu_kerja_false" name="lampu_kerja_check" value="false" />
                                Tidak
                            </label>
                            <label for="lampu_kerja_na" class="me-3 px-2 py-2">
                                <input type="radio" id="lampu_kerja_na" name="lampu_kerja_check" value="n/a" /> N/A
                            </label>
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-start">
                            ...
                            <label for="fuel_genset_false" class="me-3 px-2 py-2">
                                <input type="radio" id="fuel_genset_false" name="fuel_genset_check" value="false" />
                                Tidak
                            </label>
                            <label for="fuel_genset_na" class="me-3 px-2 py-2">
                                <input type="radio" id="fuel_genset_na" name="fuel_genset_check" value="n/a" /> N/A
                            </label>
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-start">
                            <label for="sop_jsa_true" class="me-3 px-2 py-2">
                                <input type="radio" id="sop_jsa_true" name="sop_jsa_check" value="true" required /> Ya
                            </label>
                            <label for="sop_jsa_false" class="me-3 px-2 py-2">
                                <input type="radio" id="sop_jsa_false" name="sop_jsa_check" value="false" /> Tidak
                            </label>
                            <label for="sop_jsa_na" class="me-3 px-2 py-2">
                                <input type="radio" id="sop_jsa_na" name="sop_jsa_check" value="n/a" /> N/A
                            </label>
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-start">
                            ...
                            <label for="safety_post_false" class="me-3 px-2 py-2">
                                <input type="radio" id="safety_post_false" name="safety_post_check" value="false" />
                                Tidak
                            </label>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-start">
                            <label for="rambu_apd_true" class="me-3 px-2 py-2">
                                <input type="radio" id="rambu_apd_true" name="rambu_apd_check" value="true" required />
                                Ya
                            </label>
                            <label for="rambu_apd_false" class="me-3 px-2 py-2">
                                <input type="radio" id="rambu_apd_false" name="rambu_apd_check" value="false" /> Tidak
                            </label>
                            <label for="rambu_apd_na" class="me-3 px-2 py-2">
                                <input type="radio" id="rambu_apd_na" name="rambu_apd_check" value="n/a" /> N/A
                            </label>
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-start">
                            <label for="apab_apar_true" class="me-3 px-2 py-2">
                                <input type="radio" id="apab_apar_true" name="apab_apar_check" value="true" required />
                                Ya
                            </label>
                            <label for="apab_apar_false" class="me-3 px-2 py-2">
                                <input type="radio" id="apab_apar_false" name="apab_apar_check" value="false" /> Tidak
                            </label>
                            <label for="apab_apar_na" class="me-3 px-2 py-2">
                                <input type="radio" id="apab_apar_na" name="apab_apar_check" value="n/a" /> N/A
                            </label>
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-start">
                            ...
                            <label for="p3k_eyewash_false" class="me-3 px-2 py-2">
                                <input type="radio" id="p3k_eyewash_false" name="p3k_eyewash_check" value="false" />
                                Tidak
                            </label>
                            <label for="p3k_eyewash_na" class="me-3 px-2 py-2">
                                <input type="radio" id="p3k_eyewash_na" name="p3k_eyewash_check" value="n/a" /> N/A
                            </label>
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-start">
                            ...
                            <label for="inspeksi_apar_false" class="me-3 px-2 py-2">
                                <input type="radio" id="inspeksi_apar_false" name="inspeksi_apar_check" value="false" />
                                Tidak
                            </label>
                            <label for="inspeksi_apar_na" class="me-3 px-2 py-2">
                                <input type="radio" id="inspeksi_apar_na" name="inspeksi_apar_check" value="n/a" /> N/A
                            </label>
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-start">
                            ...
                            <label for="tempat_sampah_false" class="me-3 px-2 py-2">
                                <input type="radio" id="tempat_sampah_false" name="tempat_sampah_check" value="false" />
                                Tidak
                            </label>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-start">
                            ...
                            <label for="minepermit_false" class="me-3 px-2 py-2">
                                <input type="radio" id="minepermit_false" name="minepermit_check" value="false" /> Tidak
                            </label>
                            <label for="minepermit_na" class="me-3 px-2 py-2">
                                <input type="radio" id="minepermit_na" name="minepermit_check" value="n/a" /> N/A
                            </label>
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-start">
                            ...
                            <label for="simper_operator_na" class="me-3 px-2 py-2">
                                <input type="radio" id="simper_operator_na" name="simper_operator_check" value="n/a" />
                                N/A
                            </label>
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-start">
                            <label for="padlock_true" class="me-3 px-2 py-2">
                                <input type="radio" id="padlock_true" name="padlock_check" value="true" required /> Ya
                            </label>
                            <label for="padlock_false" class="me-3 px-2 py-2">
                                <input type="radio" id="padlock_false" name="padlock_check" value="false" /> Tidak
                            </label>
                            <label for="padlock_na" class="me-3 px-2 py-2">
                                <input type="radio" id="padlock_na" name="padlock_check" value="n/a" /> N/A
                            </label>
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-start">
                            ...
                            <label for="wadah_penampung_na" class="me-3 px-2 py-2">
                                <input type="radio" id="wadah_penampung_na" name="wadah_penampung_check" value="n/a" />
                                N/A
                            </label>
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-start">
                            ...
                            <label for="wheel_chock_false" class="me-3 px-2 py-2">
                                <input type="radio" id="wheel_chock_false" name="wheel_chock_check" value="false" />
                                Tidak
                            </label>
                            <label for="wheel_chock_na" class="me-3 px-2 py-2">
                                <input type="radio" id="wheel_chock_na" name="wheel_chock_check" value="n/a" /> N/A
                            </label>
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-start">
                            ...
                            <label for="apd_standar_false" class="me-3 px-2 py-2">
                                <input type="radio" id="apd_standar_false" name="apd_standar_check" value="false" />
                                Tidak
                            </label>
                            <label for="apd_standar_na" class="me-3 px-2 py-2">
                                <input type="radio" id="apd_standar_na" name="apd_standar_check" value="n/a" /> N/A
                            </label>
                        </div>
                    ...
                    <div class="text-center mt-3">
                        <button type="submit" class="btn btn-primary btn-sm"
                            id="submitButtonKLKHFuelStation">Submit</button>
                    </div>
                </form>
