...
<head>
    ...
    <title>Kesiapan Kerja Harian</title>
    <style>
        @page {
            size: A4 landscape;
            margin: 5mm;
...
<body>
        <table style="margin-top: 20px">
            <thead>
                <tr class="no_border">
                    <th class="nobg no_border left"><img src="{{ public_path('app') }}/assets/images/sims1.png" width="240px"></th>
    ...
    <table>
        <thead> -->
            ...
            @foreach ($kkh as $item)
                ...
                <tr>
                    <td>Verifikasi</td>
                    <td style="text-align: center;padding-top: 17px;padding-bottom:17px"><img src="{{ public_path('app') }}/assets/images/centang.png" width="20px"></td>
                    <td colspan="2">
