! function (t, e) {
    ...
    var O = function () {
        ...
        X = function () {
            function t(t, e, i) {
                void 0 === t && (t = {}), this._map = i, this._elements = e, this._values = t.values || {}, this.config = t, this.config.attribute = t.attribute || "fill", t.attributes && this.setAttributes(t.attributes), "object" == typeof t.scale && (this.scale = new A(t.scale)), this.config.legend && (this.legend = new O(u({
                    map: this._map,
                    series: this
    ...
    var E = {
            ...
            _createRegions: function () {
                var t, e;
                for (t in this._regionLabelsGroup = this._regionLabelsGroup || this.canvas.createGroup("jvm-regions-labels-group"), this.mapData.paths) e = new j({
                    map: this,
                    code: t,
            ...
            coordsToPoint: function (t, e) {
                var i, s, a, n = V.maps[this.params.map].projection,
                    r = n.centralMeridian;
        ...
        V = function () {
            ...
            return e._init = function () {
                ...
                // Ambil container dari selector
                this.container = h(t.selector);

                // Validasi jika container tidak ditemukan
                if (!this.container) {
                    // console.error("Selector tidak ditemukan:", t.selector);
                    return; // Hentikan eksekusi agar tidak error
                }

                // Lanjut jika container valid
                ...
                if (t.bindTouchEvents && ("ontouchstart" in window || (window.DocumentTouch && document instanceof DocumentTouch))) {
